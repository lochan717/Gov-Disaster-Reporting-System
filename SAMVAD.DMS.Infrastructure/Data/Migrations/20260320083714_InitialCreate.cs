        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleLabel = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserDistricts", x => new { x.ApplicationUserId, x.DistrictId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserDistricts_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserDistricts_Districts_DistrictId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IncidentId = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    DistrictId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DisasterType = table.Column<int>(type: "int", nullable: false),
                    Priority = table.Column<int>(type: "int", nullable: false),
                    LocationGpsLat = table.Column<decimal>(type: "decimal(10,7)", precision: 10, scale: 7, nullable: true),
                    LocationGpsLng = table.Column<decimal>(type: "decimal(10,7)", precision: 10, scale: 7, nullable: true),
                    LocationText = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    ReporterMobile = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Incidents_Districts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "Districts",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserDistricts_DistrictId",
                table: "ApplicationUserDistricts",
                column: "DistrictId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Incidents_TrackingToken",
                table: "Incidents",
